...
| Stage | Path | Outcome |
| --- | --- | --- |
| 1 | [`stages/stage-01-meet-codex`](stages/stage-01-meet-codex/) | Meet Codex CLI, run basic workflows, and understand approval modes. |
| 2 | [`stages/stage-02-project-config`](stages/stage-02-project-config/) | Configure projects, memory, CLI settings, and reusable context. |
| 3 | [`stages/stage-03-extend-codex`](stages/stage-03-extend-codex/) | Extend Codex with skills, hooks, MCP, and project automation. |
| 4 | [`stages/stage-04-advanced`](stages/stage-04-advanced/) | Use advanced agent patterns, subagents, worktrees, and safer workflows. |
| 5 | [`stages/stage-05-build-cli-tool`](stages/stage-05-build-cli-tool/) | Build a CLI tool while applying Codex CLI practices end to end. |

Additional reference material lives in [`knowledge/`](knowledge/).
...
- [zero2codex](https://github.com/aiflowlearn/zero2codex) — Learn OpenAI Codex CLI from scratch.
- [awesome-claude-code](https://github.com/aiflowlearn/awesome-claude-code) — Curated Claude Code resources and workflows.
- [9router-starter-kit](https://github.com/aiflowlearn/9router-starter-kit) — Starter kit for model routing and AI app workflows.
- [aiflowlearn](https://github.com/aiflowlearn/aiflowlearn) — Core AIFlowLearn learning platform and skillpacks.
- [aiflowlearn-docs](https://github.com/aiflowlearn/aiflowlearn-docs) — Documentation and learning guides.
- [aiflowlearn-examples](https://github.com/aiflowlearn/aiflowlearn-examples) — Example projects and practice materials.
- [aiflowlearn-community](https://github.com/aiflowlearn/aiflowlearn-community) — Community resources, discussions, and contributions.

## License

This repository is licensed under Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International. See [`LICENSE.md`](LICENSE.md) and [`LICENSE-CC-BY-NC-SA`](LICENSE-CC-BY-NC-SA).
